/**
 * Thoughts:
 * - words, wordnet_ext and phrase_ext can be merged into single array
 * - for multiple purpose cards, Sidebar Feedback should hold array of objects
 *    - label
 *    - content (html string)
 *    - buttonlist
 *    - rewrite options
...
// TEMPLATE FOR NEXT DICTIONARY REV
